      ...
      <div className="w-full max-w-md bg-slate-800 border border-slate-700/50 rounded-xl p-8 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="name" className="text-xs font-semibold text-slate-300 pl-0.5">
              Full Name
            </label>
            <input
              id="name"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="password" className="text-xs font-semibold text-slate-300 pl-0.5">
              Password
            </label>
            <input
              id="password"
        ...
        <div className="mt-6 text-center text-xs text-slate-400 border-t border-slate-700/50 pt-5">
          ...
          <Link href="/sign-in" className="text-indigo-400 hover:text-indigo-300 font-semibold hover:underline">
            Sign in
          </Link>
        </div>
      </div>
